...
?>
<div class="card-body">
  <h4 class="card-title">güncel ideal </h4>
  <p class="card-description"> Yeni Yazı </p>
  <form id="ideal_guncelle">
    <input type="hidden" class="form-control" name="id" value="<?php echo $ideal["id"]; ?>" placeholder="id">
    <div class="form-group">
      <label for="exampleInputName1">Başlık</label>
      <input type="text" class="form-control" name="baslik" value="<?php echo $ideal["baslik"]; ?>" placeholder="Blok Başlığı">
    </div>
    <div class="form-group">
      <label for="exampleInputEmail3">Kısa Başlık</label>
      <input type="text" class="form-control" name="k_baslik" value="<?php echo $ideal["k_baslik"]; ?>" placeholder="Bloğun Kısa Başlığını Girin">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" name="icerik" rows="4"><?php echo $ideal["icerik"]; ?></textarea>
    </div>
