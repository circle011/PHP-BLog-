    ...
    <nav aria-label="breadcrumb">
        <ul class="breadcrumb">
            <li class="breadcrumb-item active" aria-current="page">
                <a href="<?php echo ANA_DIZIN ?>yonetici/ideallerim/ideal">
                    <button type="button" class="btn btn-gradient-primary btn-md">Yeni idael</button>
                </a>
            </li>
        </ul>
    </nav>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td> <a href="<?php echo ANA_DIZIN ?>yonetici/ideallerim/<?php echo $value["id"] ?>"><button type="button" class="btn btn-gradient-info btn-rounded btn-sm">Güncelle</button></a> </td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
