...
?>
<div class="card-body">
  <h4 class="card-title">Blog Yazılarım</h4>
  <p class="card-description"> Yeni Yazı </p>
  <form id="blog_yeni_yazi_guncelle">
    <input type="hidden" class="form-control" name="id" value="<?php echo $yazi["id"]; ?>" placeholder="id">
    <div class="form-group">
      <label for="exampleInputName1">Başlık</label>
      <input type="text" class="form-control" name="baslik" value="<?php echo $yazi["baslik"]; ?>" placeholder="Blok Başlığı">
    </div>
    <div class="form-group">
      <label for="exampleInputEmail3">Kısa Başlık</label>
      <input type="text" class="form-control" name="k_baslik" value="<?php echo $yazi["k_baslik"]; ?>" placeholder="Bloğun Kısa Başlığını Girin">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" name="icerik" rows="4"><?php echo $yazi["icerik"]; ?></textarea>
    </div>
