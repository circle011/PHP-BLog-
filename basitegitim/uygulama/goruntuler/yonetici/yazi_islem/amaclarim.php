    ...
    <nav aria-label="breadcrumb">
        <ul class="breadcrumb">
            <li class="breadcrumb-item active" aria-current="page">
                <a href="<?php echo ANA_DIZIN ?>yonetici/amaclarim/amac">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td> <a href="<?php echo ANA_DIZIN ?>yonetici/amaclarim/<?php echo $value["id"] ?>"><button type="button" class="btn btn-gradient-info btn-rounded btn-sm">Güncelle</button></a> </td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
