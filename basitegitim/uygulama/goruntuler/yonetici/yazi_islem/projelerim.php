    ...
    <nav aria-label="breadcrumb">
        <ul class="breadcrumb">
            <li class="breadcrumb-item active" aria-current="page">
                <a href="<?php echo ANA_DIZIN ?>yonetici/projelerim/proje">
                    <button type="button" class="btn btn-gradient-primary btn-md">Yeni Proje</button>
                </a>
            </li>
        </ul>
    </nav>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td> <a href="<?php echo ANA_DIZIN ?>yonetici/projelerim/<?php echo $value["id"] ?>"><button type="button" class="btn btn-gradient-info btn-rounded btn-sm">Güncelle</button></a> </td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
