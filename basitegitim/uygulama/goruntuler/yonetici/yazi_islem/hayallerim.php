    ...
    <nav aria-label="breadcrumb">
        <ul class="breadcrumb">
            <li class="breadcrumb-item active" aria-current="page">
                <a href="<?php echo ANA_DIZIN ?>yonetici/hayallerim/hayal">
                    <button type="button" class="btn btn-gradient-primary btn-md">Yeni hayal</button>
                </a>
            </li>
        </ul>
    </nav>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td> <a href="<?php echo ANA_DIZIN ?>yonetici/hayallerim/<?php echo $value["id"] ?>"><button type="button" class="btn btn-gradient-info btn-rounded btn-sm">Güncelle</button></a> </td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
