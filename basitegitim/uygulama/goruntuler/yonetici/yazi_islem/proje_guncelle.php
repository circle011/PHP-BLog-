...
?>
<div class="card-body">
  <h4 class="card-title">projem güncel</h4>
  <p class="card-description"> Yeni Yazı </p>
  <form id="proje_guncelle">
    <input type="hidden" class="form-control" name="id" value="<?php echo $proj["id"]; ?>" placeholder="id">
    <div class="form-group">
      <label for="exampleInputName1">Başlık</label>
      <input type="text" class="form-control" name="baslik" value="<?php echo $proj["baslik"]; ?>" placeholder="Blok Başlığı">
    </div>
    <div class="form-group">
      <label for="exampleInputEmail3">Kısa Başlık</label>
      <input type="text" class="form-control" name="k_baslik" value="<?php echo $proj["k_baslik"]; ?>" placeholder="Bloğun Kısa Başlığını Girin">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" name="icerik" rows="4"><?php echo $proj["icerik"]; ?></textarea>
    </div>
